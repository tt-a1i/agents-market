...
- `index.html`: searchable catalog for humans with target filters, quality ratings, provenance summaries, copyable workflow commands, and import workflow commands
