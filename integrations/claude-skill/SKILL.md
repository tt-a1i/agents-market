...
Always preview before installing. Treat policy failures as blockers unless the user explicitly updates the project policy. Do not use `--force` unless the user explicitly confirms overwriting or removing modified generated files.
